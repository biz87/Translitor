...
//            $this->modx->log(modX::LOG_LEVEL_INFO, 'Работаю с сис настройкой '.$name);
//            $this->modx->log(modX::LOG_LEVEL_INFO, print_r($data, 1));
...
$install = new translitorPackage(MODX_CORE_PATH, $config);
